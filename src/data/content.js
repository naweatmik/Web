...
export const aboutCourse = {
  ...
  comparison: {
    ...
    rows: [
      ...
      { aspect: '작업 환경',    web: '폰·태블릿·PC 모든 화면 크기에 맞게 설계',                  print: 'A4·B5 등 종이 규격에 맞춰 고정된 크기로 설계' },
      { aspect: '포트폴리오',   web: '링크 하나로 누구에게나 바로 공유',                          print: 'PDF 파일 또는 인쇄물로 제출' },
      { aspect: '시장 수요',    web: '스마트폰·앱 시대, 디지털 전환으로 수요 계속 증가 중',        print: '인쇄 매체 감소로 수요가 줄어드는 추세' },
      { aspect: '협업 대상',    web: '개발자·기획자·마케터와 함께 팀으로 작업',                   print: '편집장·작가·인쇄소와 작업' },
      { aspect: '부업·프리랜서', web: '쇼핑몰 상세페이지·배너 등 부업 의뢰 많음',                 print: '프리랜서 물량 적고 단가 낮음' },
